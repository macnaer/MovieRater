    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='amount in dollars', verbose_name='In the USA')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='amount in dollars', verbose_name='In the World')),
